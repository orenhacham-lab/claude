            ...
            {he ? (
              <>
                <p style={{ color: 'rgba(255,255,255,0.82)', lineHeight: 1.82, marginBottom: '18px', fontSize: '0.97rem' }}>
                  עורכת הדין דורית גיטרמן הינה עורכת דין פלילית מנוסה עם 25 שנות ניסיון בבתי משפט שלום, מחוזי ועליון בישראל. נולדה בבאר שבע, עברה לתל אביב בגיל 20 ומאז עוסקת בדיני עונשין ברמה הגבוהה ביותר.
                </p>
                <p style={{ color: 'rgba(255,255,255,0.82)', lineHeight: 1.82, marginBottom: '18px', fontSize: '0.97rem' }}>
                  לאורך הקריירה היא משלבת ניסיון מקצועי ואינטואיציה משפטית, מפתחת חשיבה חדה ושיפוט משפטי ברור — כולל תיקים עם ראיות שנדמות כבלתי ניתנות לזיכוי.
                </p>
                <p style={{ color: 'rgba(255,255,255,0.82)', lineHeight: 1.82, marginBottom: '36px', fontSize: '0.97rem' }}>
                  עבור דורית, הדין הפלילי אינו רק מקצוע. זהו ייעוד: להיות עורכת הדין הפלילית הטובה ביותר שביכולתה להיות.
                </p>
              </>
            ) : (
              <>
