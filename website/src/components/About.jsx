...
const ACHIEVEMENTS_HE = [
  'עבודה בפרקליטות זיגלמן תחת הנחייתו של עורך הדין אלי זוהר ז"ל.',
  'הופעות בבית המשפט המחוזי בפני השופט ד"ר עדי עזר ז"ל, שליווה את קריירתה עד היום.',
  'שיתוף פעולה מקצועי עם עורכי דין מובילים בתל אביב ובנצרת, עבודה משותפת על תיקים פליליים מורכבים.',
  'ייצוג תיקים פליליים ולקוחות שכיום מלמדים בעצמם באקדמיה המשפטית.',
  'לקוחות עם תיקים רגישים בוחרים בדורית — הגנה מפני אישומים ממלכתיים ועבודה עם חומרים חסויים.',
  'השתתפות בהכנת תיק אהוד אולמרט יחד עם עורך הדין אלי זוהר ז"ל ועורך הדין רמי כסיף.',
]

export default function About({ lang = 'ru' }) {
  const he = lang === 'he'
  const ACHIEVEMENTS = he ? ACHIEVEMENTS_HE : ACHIEVEMENTS_RU
            ...
            {he ? (
              <>
                <p style={{ color: 'rgba(255,255,255,0.82)', lineHeight: 1.82, marginBottom: '18px', fontSize: '0.97rem' }}>
                  עו"ד דורית גיטרמן היא עורכת דין פלילית בכירה עם ניסיון של 25 שנה במשפט הפלילי, התמחות בבתי המשפט המחוזיים והעליון ועבודה לצד בכירי המשפט בישראל.
                </p>
                <p style={{ color: 'rgba(255,255,255,0.82)', lineHeight: 1.82, marginBottom: '18px', fontSize: '0.97rem' }}>
                  ילידת באר שבע, שעברה לתל אביב עוד לפני גיל 20 מתוך שאיפה ברורה לעסוק במשפט הפלילי ברמה הגבוהה ביותר.
                </p>
                <p style={{ color: 'rgba(255,255,255,0.82)', lineHeight: 1.82, marginBottom: '18px', fontSize: '0.97rem' }}>
                  לאורך הקריירה ליוותה תיקים תקדימיים ורגישים, מתוך שילוב של מקצועיות בלתי מתפשרת, שיקול דעת עמוק ויושרה משפטית ברורה - כולל קווים אדומים שאינם נחצים.
                </p>
                <p style={{ color: 'rgba(255,255,255,0.82)', lineHeight: 1.82, marginBottom: '36px', fontSize: '0.97rem' }}>
                  עבור דורית, משפט פלילי הוא לא רק מקצוע, אלא שליחות שנבנתה מתוך מטרה אחת ברורה: להיות עורכת הדין הפלילית הטובה ביותר שהיא יכולה להיות.
                </p>
              </>
            ) : (
              <>
